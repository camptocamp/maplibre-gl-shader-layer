...
const seriesConfig = {
  ...
  // cloud_cover_low: {
  //   colormap: Colormap.fromColormapDescription(ColormapDescriptionLibrary.cloudCoverGray),
  //   style: "spectre-red",
  //   swapWaterEarth: false,
  ...
  // // cloud_cover_low: {
  // //   colormap: Colormap.fromColormapDescription(ColormapDescriptionLibrary.cloudCoverTransparent),
  // //   style: "avenue",
  // //   swapWaterEarth: false,
  ...
  //   colormap: Colormap.fromColormapDescription(ColormapDescriptionLibrary.magmaPercent),
  //   style: "spectre-negative",
  //   swapWaterEarth: true,
  //   placelayerBeforeId: "earth",
  //   layerOpacity: [
  ...
  // index: {
  //   colormap: Colormap.fromColormapDescription(ColormapDescriptionLibrary.turbo, { min: 0, max: 25, reverse: false }),
  //   style: "spectre",
  //   swapWaterEarth: false,
  //   placelayerBeforeId: "water",
