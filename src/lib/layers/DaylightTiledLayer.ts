...
export type DaylightLayerOptions = {
  /**
   * Date and time at which to show the night/day layer
   */
  date?: Date;

  /**
   * Opacity of the layer in [0, 1].
   * Will be a factor aaplied to the colormap.
   */
  opacity?: number;

  /**
   * A custom colormap. The values are mapped on the sun altitude in degrees, where negative
